...
//                logger.info(updateMessage);
            ...
            //我的粉丝所有的文章
        } else if ("/show/authorMessage.do".equals(request.getServletPath())) {
            int authorId = Integer.parseInt(request.getParameter("authorId"));
            List<Message> messages = messageService.getUserMessageList(authorId);
            ...
            request.setAttribute("messages", messageSrcs);
            request.setAttribute("user", user);
            request.getRequestDispatcher("/WEB-INF/views/authorMessage.jsp").forward(request, response);
        }
    }
